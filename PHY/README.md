...
本次补读入口（2026-09-25）：[MEM16](sources/MEM16-dfi51-interface.md)、[MEM15](sources/MEM15-pg150-dqs-gate.md)。DFI 5.1 转录补启动与数据有效期；2022 PG150 原图补完整阶段、rank 分支和灰色未实现项。2025 图、DFI 6.0 HBM profile 与器件时序仍待原版，不合并年代。
