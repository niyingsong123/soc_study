...
本次补读入口（2026-09-25）：[MEM11](sources/MEM11-jedec-scope-gap.md)、[MEM9](sources/MEM9-micron-hbm3e.md)、[MEM10](sources/MEM10-samsung-hbm3.md)。MEM11 已从纯入口推进到 JESD238A 正文转录选读，支持 PC、共享命令与 CK/DQS 的架构分解；完整规范图表及具体料号 datasheet 仍有缺口。
