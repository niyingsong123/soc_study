...
- [芯片学习与微架构研究计划](chip-study-plan.md)：用户确认的长期维护范本，包含六步流程、模块方案结构、资料集与引用、完成条件和更新方式。
- [项目上下文](project-context.md)：当前 AMD 项目范围、SWITCH 起点、资料现状与后续问题。
...
多轮论文研究统一采用 [芯片学习与微架构研究计划](chip-study-plan.md)。本项目先复核 SWITCH 已完成的两轮及剩余计划，再逐模块完成方案；详细展开由后续本地 Codex 接续。项目范围与实际进度见 [项目上下文](project-context.md)。
