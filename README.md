...
- [项目上下文](project-context.md)：目标、AMD/行业术语研究规则、微架构优先的多轮规划要求、资料现状与后续问题。
...
当前多轮论文规划按模块逐一推进：先核对 AMD 名称与行业术语，再依据高质量资料建立整体微架构，映射子模块和 feature，最后安排适合该模块的研究轮次。先复核 SWITCH 已完成的两轮及剩余计划，详细展开由后续本地 Codex 接续；跨模块专题在各模块方案完成后评估。完整要求见 [项目上下文](project-context.md)。
